    ...
    <div
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            ...
            <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">Sorry, the page you are looking for could not
                be found.</p>
            <a href="/"
                class="flex items-center space-x-2 bg-sky-500 hover:bg-sky-600 text-gray-100 px-4 py-2 rounded transition duration-150"
                title="Return Home">
        ...
        <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
            <svg class="w-full text-blue-500" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                ...
                <path
                    ...
                    transform="translate(-39.70387 -61.04208)" fill="#009ed8"></path>
                <path
