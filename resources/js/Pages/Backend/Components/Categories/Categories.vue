...
<template>
    <div class="w-full bg-base-100 p-5 rounded-lg shadow-sm">
        <div class="flex justify-between items-center">
            <h1 class="font-semibold text-gray-500 mb-5">Categorys</h1>

            <!-- Desktop buttons - hidden on mobile -->
            <div class="hidden md:flex space-x-5">
                <button class="btn bg-blue-500 hover:bg-blue-400 text-white" onclick="addCategory.showModal()">
                    Add Category
                </button>
            ...
            <div class="md:hidden">
                <details class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                        <li><a class="text-gray-500 " onclick="addCategory.showModal()">Add Category</a></li>
                        <li>
                            <details class="dropdown">
