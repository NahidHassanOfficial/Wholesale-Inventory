...
<template>
    ...
    <section class="drawer lg:drawer-open">
        ...
        <section class="drawer-content flex flex-col">
            ...
            <header class="navbar bg-base-200 px-5 py-4">
                <label for="my-drawer-2" class="btn bg-blue-500 text-white drawer-button lg:hidden mr-5">
                    ...
                    <div class="dropdown dropdown-end">
                        <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                            <div class="w-10 rounded-full">
                                <img alt="Tailwind CSS Navbar component" :src="'/images/users/admin-user.svg'" />
                            </div>
                        </div>
                        <ul tabindex="0"
        ...
        <section class="drawer-side">
            ...
            <ul class="menu bg-base-200 min-h-full w-60 md:w-72 p-4 text-base-content text-base">
                <li>
                    <img :src="'/images/logo-horizontal.svg'" class="w-48 mt-5 mb-10" />
                </li>
                <li>
                    <Link :href="route('dashboard')" class="flex justify-start items-center gap-3">
                    <span>
                ...
                <li>
                    <Link :href="route('inventory')" class="flex justify-start items-center gap-3">
                    <span>
                ...
                <li>
                    <Link :href="route('reports')" class="flex justify-start items-center gap-3">
                    <span>
                ...
                <li>
                    <Link :href="route('suppliers')" class="flex justify-start items-center gap-3">
                    <span>
                ...
                <li>
                    <Link :href="route('orders')" class="flex justify-start items-center gap-3">
                    <span>
                ...
                <li>
                    <Link :href="route('stores')" class="flex justify-start items-center gap-3">
                    <span>
